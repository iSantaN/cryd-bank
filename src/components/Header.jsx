...
// 🖼️ Importa tus imágenes locales
    ...
    <header className="relative bg-gray-900 text-white rounded-lg overflow-hidden shadow-lg h-[50vh] md:h-[65vh]">
      ...
      <div className="relative h-full w-full">
        ...
        <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex gap-3 z-10">
          <button onClick={prev} className="bg-white/30 px-3 py-1 rounded hover:bg-white/50">◀</button>
          <button onClick={next} className="bg-white/30 px-3 py-1 rounded hover:bg-white/50">▶</button>
        </div>
